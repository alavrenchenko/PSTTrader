...
{
    public class MFIXDropCopy : ServiceBase
    {
        public MFIXDropCopy(ProSecuritiesTrading.MOEX.FIX.ASTS.ASTSAdapter adapter)
            : base(adapter, 3, "MFIXDropCopy")
        {
            ...
            base.Messages = new Message.Messages(new Group.Header(Field.BeginString.BeginStringBytes, settings.SenderCompID[2], settings.TargetCompID[2], 0, 0));

            base.Ip = settings.IpArray[2];
            base.Port = settings.PortArray[2];
        }
